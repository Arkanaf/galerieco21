...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth','admin'])->group(function () {
        ...
        Route::resource('content', SiteContentController::class, ['as' => 'admin', 'parameters' => ['content' => 'content']]);
        Route::delete('content/{content}', [SiteContentController::class, 'destroy'])->name('admin.content.destroy');
