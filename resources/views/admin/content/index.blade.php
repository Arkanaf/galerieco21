                        ...
                        <tbody>
                            @foreach($contents[$section] as $content)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.content.edit', $content) }}" class="btn btn-sm btn-warning">Edit</a>
                                        
                                        <form action="{{ route('admin.content.destroy', $content) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
